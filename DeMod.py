...
class DeMod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "GFSK Mod DeMod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK Mod DeMod")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/erika/Desktop/3UCubed/GFSK_demod.bin', False)
        ...
        self.connect((self.blocks_uchar_to_float_1, 0), (self.qtgui_waterfall_sink_x_0, 0))
